<?php
/**
 * update document from ZendFW
 * 13/12/24 a.ide created
 * 14/5/9 a.ide modified
 */
...
{
	$modx = $this->modx;
	$modx->manager= new ManagerAPI;

//from manager/index.php
...
/*
print "this->modx=";
print $modx->hasPermission("save_document");
//print_r($modx->manager);
print "<br>\n";
print "POST";
print "<br>\n";
print_r($_POST);
...
/*
 $_POST["id"]
 $_POST["mode"] ...4(create), 27(edit), 6(delete)
 $_POST["chkalldocs"]
 $_POST["template"]
 * 
$_POST["mode"] = 4;	//create
...
if ($editedby == "") $editedby = 0;	//public user
//
...
switch ($actionToTake)
{
	case 'new' :
		...
		$params = array();
		$params['mode'] = 'new';
//a.ide		$modx->invokeEvent('OnBeforeDocFormSave', $params);
...
//		$createdby = $modx->getLoginUserID();
		...
		if ($createdby == "") $createdby = 0;	//public user
		//
		...
		$params['mode'] = 'new';
		$params['id']   = $newid;
//a.ide		$modx->invokeEvent('OnDocFormSave', $params);
